...
class UniMatch(nn.Module):
    ...
    def extract_feature(self, img0, img1):
        ...
        features = self.backbone(concat)  # [2B, C', H/4, W/4], [2B, C', H/8, W/8], "/" means (ceil(x/2))^k
        features = features[::-1]# [2B, C', H/8, W/8], [2B, C', H/4, W/4]
    ...
    def forward(self, img0, img1,
        ...
        feature0_list, feature1_list = self.extract_feature(img0, img1)  # list of features:[(B, 128, 30, 40), (B, 128, 60, 80)]
