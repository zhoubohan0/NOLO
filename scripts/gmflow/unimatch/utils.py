...
def feature_add_position(feature0, feature1, attn_splits, feature_channels):
    ...
    if attn_splits > 1:  # add position in splited window
        feature0_splits = split_feature(feature0, num_splits=attn_splits)# 1, 128, 30, 40 -> 4, 128, 15, 20; 1, 128, 60, 80
        feature1_splits = split_feature(feature1, num_splits=attn_splits)

        position = pos_enc(feature0_splits)  # 4, 128, 15, 20

        feature0_splits = feature0_splits + position
        feature1_splits = feature1_splits + position

        feature0 = merge_splits(feature0_splits, num_splits=attn_splits) # 4, 128, 15, 20
